...
import (
	context "github.com/alswl/go-toodledo/pkg/client0/context"
...
func (_m *ClientService) GetContextsGetPhp(params *context.GetContextsGetPhpParams, authInfo runtime.ClientAuthInfoWriter, opts ...context.ClientOption) (*context.GetContextsGetPhpOK, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetContextsGetPhp")
	}

	var r0 *context.GetContextsGetPhpOK
	var r1 error
	if rf, ok := ret.Get(0).(func(*context.GetContextsGetPhpParams, runtime.ClientAuthInfoWriter, ...context.ClientOption) (*context.GetContextsGetPhpOK, error)); ok {
...
func (_m *ClientService) PostContextsAddPhp(params *context.PostContextsAddPhpParams, authInfo runtime.ClientAuthInfoWriter, opts ...context.ClientOption) (*context.PostContextsAddPhpOK, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for PostContextsAddPhp")
	}

	var r0 *context.PostContextsAddPhpOK
	var r1 error
	if rf, ok := ret.Get(0).(func(*context.PostContextsAddPhpParams, runtime.ClientAuthInfoWriter, ...context.ClientOption) (*context.PostContextsAddPhpOK, error)); ok {
		return rf(params, authInfo, opts...)
	}
...
func (_m *ClientService) PostContextsDeletePhp(params *context.PostContextsDeletePhpParams, authInfo runtime.ClientAuthInfoWriter, opts ...context.ClientOption) (*context.PostContextsDeletePhpOK, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for PostContextsDeletePhp")
	}

	var r0 *context.PostContextsDeletePhpOK
	var r1 error
	if rf, ok := ret.Get(0).(func(*context.PostContextsDeletePhpParams, runtime.ClientAuthInfoWriter, ...context.ClientOption) (*context.PostContextsDeletePhpOK, error)); ok {
		return rf(params, authInfo, opts...)
	}
...
func (_m *ClientService) PostContextsEditPhp(params *context.PostContextsEditPhpParams, authInfo runtime.ClientAuthInfoWriter, opts ...context.ClientOption) (*context.PostContextsEditPhpOK, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for PostContextsEditPhp")
	}

	var r0 *context.PostContextsEditPhpOK
	var r1 error
	if rf, ok := ret.Get(0).(func(*context.PostContextsEditPhpParams, runtime.ClientAuthInfoWriter, ...context.ClientOption) (*context.PostContextsEditPhpOK, error)); ok {
		return rf(params, authInfo, opts...)
	}
