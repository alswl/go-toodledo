...
func (_m *ClientService) GetFoldersGetPhp(params *folder.GetFoldersGetPhpParams, authInfo runtime.ClientAuthInfoWriter, opts ...folder.ClientOption) (*folder.GetFoldersGetPhpOK, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetFoldersGetPhp")
	}

	var r0 *folder.GetFoldersGetPhpOK
	var r1 error
	if rf, ok := ret.Get(0).(func(*folder.GetFoldersGetPhpParams, runtime.ClientAuthInfoWriter, ...folder.ClientOption) (*folder.GetFoldersGetPhpOK, error)); ok {
...
func (_m *ClientService) PostFoldersAddPhp(params *folder.PostFoldersAddPhpParams, authInfo runtime.ClientAuthInfoWriter, opts ...folder.ClientOption) (*folder.PostFoldersAddPhpOK, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for PostFoldersAddPhp")
	}

	var r0 *folder.PostFoldersAddPhpOK
	var r1 error
	if rf, ok := ret.Get(0).(func(*folder.PostFoldersAddPhpParams, runtime.ClientAuthInfoWriter, ...folder.ClientOption) (*folder.PostFoldersAddPhpOK, error)); ok {
		return rf(params, authInfo, opts...)
	}
...
func (_m *ClientService) PostFoldersDeletePhp(params *folder.PostFoldersDeletePhpParams, authInfo runtime.ClientAuthInfoWriter, opts ...folder.ClientOption) (*folder.PostFoldersDeletePhpOK, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for PostFoldersDeletePhp")
	}

	var r0 *folder.PostFoldersDeletePhpOK
	var r1 error
	if rf, ok := ret.Get(0).(func(*folder.PostFoldersDeletePhpParams, runtime.ClientAuthInfoWriter, ...folder.ClientOption) (*folder.PostFoldersDeletePhpOK, error)); ok {
		return rf(params, authInfo, opts...)
	}
...
func (_m *ClientService) PostFoldersEditPhp(params *folder.PostFoldersEditPhpParams, authInfo runtime.ClientAuthInfoWriter, opts ...folder.ClientOption) (*folder.PostFoldersEditPhpOK, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for PostFoldersEditPhp")
	}

	var r0 *folder.PostFoldersEditPhpOK
	var r1 error
	if rf, ok := ret.Get(0).(func(*folder.PostFoldersEditPhpParams, runtime.ClientAuthInfoWriter, ...folder.ClientOption) (*folder.PostFoldersEditPhpOK, error)); ok {
		return rf(params, authInfo, opts...)
	}
