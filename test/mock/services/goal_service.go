...
// NewGoalService creates a new instance of GoalService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewGoalService(t testing.TB) *GoalService {
	mock := &GoalService{}
	mock.Mock.Test(t)
