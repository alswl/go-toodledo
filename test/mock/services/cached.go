...
// NewCached creates a new instance of Cached. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewCached(t testing.TB) *Cached {
	mock := &Cached{}
	mock.Mock.Test(t)
