...
// FindUserByToken provides a mock function with given fields: accessToken, refreshToken
func (_m *AccountExtService) FindUserByToken(accessToken string, refreshToken string) (*models.Account, error) {
...
// GetLastFetchInfo provides a mock function with given fields:
...
// SetLastFetchInfo provides a mock function with given fields: account
