...
func (_m *TaskCachedService) Create(title string) (*models.Task, error) {
	ret := _m.Called(title)
...
func (_m *TaskCachedService) EditByQuery(query *queries.TaskEditQuery) (*models.Task, error) {
	ret := _m.Called(query)
...
func (_m *TaskCachedService) ListAll() ([]*models.Task, int, error) {
	ret := _m.Called()
...
type mockConstructorTestingTNewTaskCachedService interface {
	mock.TestingT
	Cleanup(func())
}

// NewTaskCachedService creates a new instance of TaskCachedService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewTaskCachedService(t mockConstructorTestingTNewTaskCachedService) *TaskCachedService {
