...
// NewFolderCachedService creates a new instance of FolderCachedService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewFolderCachedService(t testing.TB) *FolderCachedService {
