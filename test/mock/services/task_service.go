...
func (_m *TaskService) Create(name string) (*models.Task, error) {
	ret := _m.Called(name)
...
// NewTaskService creates a new instance of TaskService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewTaskService(t testing.TB) *TaskService {
	mock := &TaskService{}
	mock.Mock.Test(t)
