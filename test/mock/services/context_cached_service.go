...
type mockConstructorTestingTNewContextCachedService interface {
	mock.TestingT
	Cleanup(func())
}

// NewContextCachedService creates a new instance of ContextCachedService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewContextCachedService(t mockConstructorTestingTNewContextCachedService) *ContextCachedService {
