...
// TaskLocalService is an autogenerated mock type for the TaskLocalService type
type TaskLocalService struct {
	mock.Mock
}

// Complete provides a mock function with given fields: id
func (_m *TaskLocalService) Complete(id int64) (*models.Task, error) {
	ret := _m.Called(id)
...
func (_m *TaskLocalService) Create(title string) (*models.Task, error) {
	ret := _m.Called(title)
...
func (_m *TaskLocalService) CreateByQuery(query *queries.TaskCreateQuery) (*models.Task, error) {
	ret := _m.Called(query)
...
func (_m *TaskLocalService) Delete(id int64) error {
	ret := _m.Called(id)
...
func (_m *TaskLocalService) DeleteBatch(ids []int64) ([]int64, []*models.TaskDeleteItem, error) {
	ret := _m.Called(ids)
...
func (_m *TaskLocalService) Edit(id int64, t *models.Task) (*models.Task, error) {
	ret := _m.Called(id, t)
...
func (_m *TaskLocalService) EditByQuery(query *queries.TaskEditQuery) (*models.Task, error) {
	ret := _m.Called(query)
...
func (_m *TaskLocalService) FindById(id int64) (*models.Task, error) {
	ret := _m.Called(id)
...
func (_m *TaskLocalService) List(start int64, limit int64) ([]*models.Task, *models.PaginatedInfo, error) {
...
func (_m *TaskLocalService) ListAll() ([]*models.Task, int, error) {
	ret := _m.Called()
...
func (_m *TaskLocalService) ListAllByQuery(query *queries.TaskListQuery) ([]*models.Task, error) {
	ret := _m.Called(query)
...
func (_m *TaskLocalService) ListDeleted(lastEditTime *int32) ([]*models.TaskDeleted, error) {
...
func (_m *TaskLocalService) LocalClear() error {
	ret := _m.Called()
...
func (_m *TaskLocalService) PartialSync(lastEditTime *int32) error {
	ret := _m.Called(lastEditTime)
...
func (_m *TaskLocalService) Sync() error {
	ret := _m.Called()
...
func (_m *TaskLocalService) UnComplete(id int64) (*models.Task, error) {
	ret := _m.Called(id)
...
type mockConstructorTestingTNewTaskLocalService interface {
	mock.TestingT
	Cleanup(func())
}

// NewTaskLocalService creates a new instance of TaskLocalService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewTaskLocalService(t mockConstructorTestingTNewTaskLocalService) *TaskLocalService {
	mock := &TaskLocalService{}
	mock.Mock.Test(t)
