...
func (a *Client) GetAccountGetPhp(params *GetAccountGetPhpParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetAccountGetPhpOK, error) {
	...
	if params == nil {
		params = NewGetAccountGetPhpParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetAccountGetPhp",
		Method:             "GET",
		PathPattern:        "/account/get.php",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetAccountGetPhpReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*GetAccountGetPhpOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetAccountGetPhp: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
