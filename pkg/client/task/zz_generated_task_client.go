...
func (a *Client) GetTasksDeletedPhp(params *GetTasksDeletedPhpParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetTasksDeletedPhpOK, error) {
	...
	if params == nil {
		params = NewGetTasksDeletedPhpParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetTasksDeletedPhp",
		Method:             "GET",
		PathPattern:        "/tasks/deleted.php",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetTasksDeletedPhpReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*GetTasksDeletedPhpOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetTasksDeletedPhp: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
